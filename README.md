...
Automatically extract and summarize your [Claude Code](https://docs.anthropic.com/en/docs/claude-code) sessions into daily reports. Zero dependencies beyond Python 3.8+ stdlib.
...
The installer will:
- Symlink `daily-claude-log` to `~/.local/bin/`
...
This removes the hook, skills, and symlink. Your data in `$DCL_DATA_DIR` is preserved.
